module DUKPT
  class Encrypter
    ...
    def encrypt(plaintext, ksn)
      ...
      encrypted_cryptogram = triple_des_encrypt(pek, plaintext.unpack("H*").first).upcase
    end
    ...
    def encrypt_data_block(plaintext, ksn)
      ...
      encrypted_cryptogram = triple_des_encrypt(dek, plaintext.unpack("H*").first).upcase
    end
