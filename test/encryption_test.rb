...
class DUKPT::EncryptionTest < Test::Unit::TestCase
  ...
  def test_triple_des_decrypt
    ...
    if defined?(RUBY_ENGINE) && RUBY_ENGINE == 'jruby'
      assert_raise RuntimeError do
        triple_des_decrypt('27f66d5244ff621eaa6f6120edeb427f', ciphertext)
      end
    else
  ...
  if defined?(RUBY_ENGINE) && RUBY_ENGINE == 'jruby'
    def test_triple_des_decrypt_jruby
      ciphertext = "c25c1d1197d31caa"
      data_decrypted = triple_des_decrypt('27f66d5244ff621eaa6f6120edeb427f', ciphertext)
      assert_equal '2542353435323330', data_decrypted
    end
  end
  ...
  def test_dek_from_key
    ...
    dek = dek_from_key(key, false)
    assert_equal "C39B2778B058AC376FB18DC906F75CBA", dek.upcase
  end

  def test_dek_variant_from_key
    key = "27F66D5244FF62E1AA6F6120EDEB4280"
    dek = dek_from_key(key, true)
    assert_equal "27F66D52440062E1AA6F6120ED144280", dek.upcase
  end

  def test_derive_dek_counter_13
    ksn = "FFFF9876543210E00013"
    dek = derive_DEK('6ac292faa1315b4d858ab3a3d7d5933a', ksn, false)
    assert_equal '44893E3434ABDD6A817CE2841825E1FD', dek.upcase
  end

  def test_derive_dek_variant_counter_13
    ksn = "FFFF9876543210E00013"
    dek = derive_DEK('6ac292faa1315b4d858ab3a3d7d5933a', ksn, true)
    assert_equal 'C3DF489FDFEE53B4F03DE97C27234C2F', dek.upcase
  end
